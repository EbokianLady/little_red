...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const buffer = document.getElementById('canvas-buffer');

  const game = new Game(canvas, far, mid, near, fore, house, buffer);
  ...
  function resizeGame() {
    const gameArea = document.getElementById('canvas-box');
