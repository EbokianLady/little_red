...
class Game {
  constructor(canvas, far, mid, near, fore, house, touchScreen) {
    this.canvas = canvas;
    this.farCanvas = far;
    this.midCanvas = mid;
  ...
  initializeGame() {
    ...
    this.touchScreen.addEventListener('click', (e) => this.touchJump(e));
  }
  ...
  touchJump(e) {
    debugger
    if (e.target.id === 'touch-screen' && this.littleRed.jumps < 3) {
      this.littleRed.jump();
    }
  }
